    ...
    <>
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-4">
                    <h1 class="text-center mt-2">Activity</h1>
                    <div class="mt-4">
                        <p class="text-center mt-2">{username}</p>
                        <h1 class="text-center mt-2" style={{"font-size": "2em"}}>
                            Bola na, Kaam Chal riya he abhi.
                        </h1>
...
export default ActivityStylish